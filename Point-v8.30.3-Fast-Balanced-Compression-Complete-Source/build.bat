...
cl /nologo /std:c++20 /utf-8 /EHsc /W4 /WX /sdl /guard:cf ^
  ...
  /link /DYNAMICBASE /NXCOMPAT /GUARD:CF ^
  user32.lib gdi32.lib comctl32.lib shell32.lib ole32.lib advapi32.lib winhttp.lib
if errorlevel 1 exit /b 1
cl /nologo /std:c++20 /utf-8 /EHsc /W4 /WX /sdl /guard:cf ^
  /DUNICODE /D_UNICODE /O2 /MT ^
  src\point_core.cpp src\point_fast_compression.cpp src\point_compliance.cpp src\point_excel_import.cpp src\point_win32.cpp ^
